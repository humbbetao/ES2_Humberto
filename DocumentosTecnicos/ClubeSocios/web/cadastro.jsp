    ...
    <body>
        ...
        <div class="cadastro-block">
            <form action="CadastroServlet" id="formCadastro" method="POST">
                ...
                <h1>Cadastro</h1>
                <input type="email" value="" name="email" placeholder="Email" id="useremail" required/>
                <input type="password" value="" name="senha" placeholder="Senha" id="password" onchange="formCadastro.passwordC.pattern = this.value;" required/>
